...
public class GOST {
  ...
  private final static int[] keyMap = {0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2, 3, 4, 5, 6, 7, 7, 6, 5, 4, 3, 2, 1, 0};
    ...
    public static void main(String[] args) {
        ...
        String path2 = "D://IdeaProjects/Gost/NEW/text2.txt";
        DataOutputStream out = null;
        try {
            out = new DataOutputStream(new FileOutputStream(path2));
        ...
        String path1 = "D://IdeaProjects/Gost/NEW/text1.txt" ;
        DataInputStream in = null;
        try {
            in = new DataInputStream(new FileInputStream(path1));
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        ...
        try {
            gost.rpz(Mode.ENCRYPT, out ,  in );
        } catch (Exception e) {
            e.printStackTrace();
        }
        System.out.println(gost.key);  //выводит ключ, который использовался (256 бит)( не уверен, правильно ли выводится)
